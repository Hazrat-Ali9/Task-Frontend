...
export default function Home() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (res.data.shops) {
        localStorage.setItem("shops", JSON.stringify(res.data.shops));
      }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800 p-4">
      <div className="relative w-full max-w-md">
        <div className="relative bg-gray-900/80 backdrop-blur-md rounded-2xl shadow-2xl overflow-hidden border border-white/10">
          <div className="px-10 py-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <button
                  type="submit"
                  className="bg-cyan-800 hover:bg-cyan-600 transition-colors duration-300 text-white rounded p-2 mt-3 w-full"
                >
                  Login
                </button>
              </div>
